...
<body>
    <div id="dashboard" class="p-4 container">
        <h1 class="mb-5 text-center">New Dorm</h1>
        <a class="fs-4" href="/dorms">Dashboard</a>
        <form:form class="p-4 mt-4 mb-5 border shadow fs-5" action="/dorms/new" method="POST" modelAttribute="dorm">
        	<div class="row">
        		<form:label path="name" class="col-sm-3 form-label fw-semibold">Name:</form:label>
        		<div class="mb-4 col-sm-9">
        			<form:input type="text" class="form-control fs-5" path="name" placeholder="Enter dorm name"/>
