...
<body>
    <div id="regForm" class="p-4 container">
    	<div class="mb-5 d-flex align-items-center justify-content-between">
        	<h1 class="mb-0 fw-bold">Change Your Entry</h1>
        	<a class="fs-4" href="/bookmarket">Back to the shelves</a>
        </div>
        <div class="row justify-content-between">
        	<form:form class="p-3 col-sm-12 card bg-secondary-subtle bg-gradient shadow" action="/books/${book.getId()}/edit" method="PUT" modelAttribute="book">
        		<div class="card-body">
        			<form:input type="hidden" path="user.id" value="${currentUser.getId()}"/>
        			<c:if test="${book.getBorrower().getId() ne null}">
        				<form:input type="hidden" path="borrower.id" value="${book.getBorrower().getId()}"/>
        			</c:if>
        			<div class="row mb-4 g-3 align-items-center justify-content-between">
        				...
        				<div class="col-sm-10">
        					<form:input type="text" class="form-control fs-5" path="title" placeholder="Enter title"/>
        			...
        			<div class="row mb-5 g-3 align-items-center justify-content-between">
        				...
        				<div class="col-sm-10">
        					<form:textarea type="text" class="form-control fs-5" rows="4" path="thoughts" placeholder="Enter your thoughts on the book"/>
