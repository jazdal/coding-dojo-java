public class AlfredTest {
    public static void main(String[] args) {
        ...
        String ninjaGreeting = alfredBot.guestGreeting("Beth Kane", "afternoon");

        String angryOutBurst = alfredBot.angryAlfred("of course, your wish is always my command");
        ...
        System.out.println(angryOutBurst);
    }
}